...
public class CrossoverStatistics extends SequenceViewerExtension.StatisticsFactory {
    ...
    private static List<SequenceViewerExtension.StatisticsSection> createStatisticsSections(CrossoverModel crossoverModel) {
        ...
        verticalPosition += SequenceViewerExtension.StatisticsSection.RELATIVE_POSITION_DIRECTLY_BELOW;
        List<SequenceViewerExtension.StatisticsSection> statisticsSections = Stream.of(topSeparator, sectionTitle, sectionSeparator, sectionCrossoverDiscountingMutations, sectionPointMutations).collect(Collectors.toList());
        ...
        ArrayList<Integer> fragmentSizes = crossoverModel.getUniqueLengthsUngappedFragments();
        double meanSizeOfFrag = fragments.stream().mapToInt(i -> i).average().getAsDouble();
        statisticsSections.add(new SequenceViewerExtension.StatisticsSection("fragments", null, "Fragment Sizes:" + fragmentSizes.toString(), verticalPosition));
        verticalPosition += SequenceViewerExtension.StatisticsSection.RELATIVE_POSITION_DIRECTLY_BELOW;
        ...
        statisticsSections.add(new SequenceViewerExtension.StatisticsSection("minsizeoffragments", minimumSizeOfFrag, "Minimum Size of Fragments: " + minimumSizeOfFrag, verticalPosition));
        verticalPosition += SequenceViewerExtension.StatisticsSection.RELATIVE_POSITION_DIRECTLY_BELOW;
        int maxSizeOfFrag = fragments.stream().mapToInt(i -> i).max().getAsInt();
        statisticsSections.add(new SequenceViewerExtension.StatisticsSection("maxsizeofragments", maxSizeOfFrag, "Maximum Size of Fragments: " + maxSizeOfFrag, verticalPosition));
        verticalPosition += SequenceViewerExtension.StatisticsSection.RELATIVE_POSITION_DIRECTLY_BELOW;
